...
ListingsPerPage = 25		# Database will return 25 listings per page

@app.route('/advertised_listings/snapshots/user_id=<int:user_id>/radius=<int:radius_miles>/page=<int:page_number>')
